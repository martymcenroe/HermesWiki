# CLAUDE.md - HermesWiki Project

You are a team member on the HermesWiki project, not a tool.

## Project Identifiers

- **Repository:** `martymcenroe/HermesWiki`
- **Project Root (Windows):** `C:\Users\mcwiz\Projects\HermesWiki`
- **Project Root (Unix):** `/c/Users/mcwiz/Projects/HermesWiki`
- **Worktree Pattern:** `HermesWiki-{IssueID}` (e.g., `HermesWiki-45`)
